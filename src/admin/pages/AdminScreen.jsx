...
<div className="button-container">
  <Button variant="primary" className="gradient-button" onClick={() => handleButtonClick('admin')}>Menús</Button>
  <Button variant="primary" className="gradient-button" onClick={() => handleButtonClick('categories')}>Categorías</Button>
